...
class InstituteController extends Controller
{
    ...
    public function index()
    {
        ...
        $unitInstitutes = UnitInstitutes::select('id','vision', 'message')->first();
         return view('pages.institutes.index', compact('institutes', 'unitInstitutes'));
    }

    public function create()
    {
        $unitInstitutes =  UnitInstitutes::select('id','vision', 'message')->get();
        return view('pages.institutes.create', compact('unitInstitutes'));
    }

    public function store(Request $request)
    {
        $validated = $request->validate([
            'unit_institute_id' => 'nullable|exists:unit_institutes,id',
        ...
        if (empty($validated['unit_institute_id'])) {
            $validated['unit_institute_id'] = optional(UnitInstitutes::first())->id;
        }
    ...
    public function edit(string $id)
    {
        ...
        $unitInstitutes = UnitInstitutes::select('id','vision', 'message')->first();
        return view('pages.institutes.edit', compact('institute', 'unitInstitutes'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if (empty($validated['unit_institute_id'])) {
            $validated['unit_institute_id'] = $institute->unit_institute_id ?: optional(UnitInstitutes::first())->id;
        }
