...
class ProgramRequirementRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'file_path.required' => 'ملف متطلبات البرنامج مطلوب',
            'file_path.file' => 'ملف متطلبات البرنامج يجب أن يكون ملف',
            'file_path.mimes' => 'ملف متطلبات البرنامج يجب أن يكون من نوع PDF أو Word',
            'file_path.max' => 'حجم ملف متطلبات البرنامج يجب أن يكون أقل من 10 ميجابايت',
        ];
    }
}
