...
@section('title', '    اللائحه الداخليه ')
...
@section('page-header')
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋   اللائحه الداخليه </h2>
        <p class="mg-b-0"> يعرض جدول اللائحه الداخليه </p>
      </div>
    </div>
...
@section('content')
  <div class="container-fluid py-4">
    <div class="card shadow-sm">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">اللائحه الداخليه</h5>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered align-middle" id="internalTable">
            <thead>
              <tr>
                <th>#</th>
                <th>الوحدة</th>
            ...
            <tbody>
              @forelse($items as $item)
                <tr>
                  ...
                  <td>
                    @if($item->file_path)
                      ...
                      <a class="btn btn-outline-info btn-sm" href="{{ route('internal-permanencies.download', $basename) }}" target="_blank">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <li>
                          <form action="{{ route('internal-permanencies.destroy', $item->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('delete')
                ...
                @include('pages.internal_permanencies._edit', ['item' => $item, 'units' => $units])
              @empty
  ...
  @include('pages.internal_permanencies._create', ['units' => $units])
@endsection
