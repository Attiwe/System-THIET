...
@section('page-header')
  ...
  <!-- breadcrumb -->
    ...
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋  الأنشطة </h2>
        <p class="mg-b-0"> يعرض جدول الأنشطة </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <h2 class="text-primary mb-3">📋 جدول الأنشطة</h2>

      <div class="d-flex justify-content-center ">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold"> إضافة الانشطه </strong>
        </button>
      </div>

      <!-- Model academic_years -->
      @include('pages.activities._create')
      ...
      <table id="example1"
        ...
        <thead class="px-3 py-2  text-white">
          <tr>
            <th scope="col">#</th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-calendar-week"></i> النشطه</th>
        ...
        <tbody>
          @foreach($activities as $item)
            ...
            <!-- model edit -->
            @include('pages.activities._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
...
@section('js')
    ...
    @include('pages.activities._delete')
@endsection