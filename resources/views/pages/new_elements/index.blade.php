...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> <i class="bi bi-eye-fill"></i> عناصر الأخبار </h2>
        <p class="mg-b-0"> يعرض جدول عناصر الأخبار </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <h2 class="text-primary mb-3"> <i class="bi bi-eye-fill"></i> عناصر الأخبار</h2>

      <div class="d-flex justify-content-center ">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createArticle">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold">  إضافة  عنصر الخبر</strong>
        </button>
      </div>
      <br>

      <!-- Model academic_years -->
      @include('pages.new_elements._create')
        ...
        <tbody>
          @foreach($newElements as $item)
            <tr>
              ...
              <td class="fw-bold text-primary">{{ $item->created_at }}</td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                      <form action="{{ route('new_elements.destroy', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.new_elements._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
...
@section('js')
  ...
  @include('pages.new_elements._delete')
@endsection