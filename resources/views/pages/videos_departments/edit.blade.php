  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div class="breadcrumb-title">
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">تعديل فيديو قسم</h2>
        <p class="mg-b-0">تعديل فيديو القسم المحدد</p>
      </div>
    </div>
  ...
  <div class="row row-sm">
    <div class="col-lg-8">
      <div class="card custom-card">
        <div class="card-body">
          <form action="{{ route('videos_departments.update', $videosDepartment->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                  ...
                  <select name="department_id" id="department_id" class="form-control @error('department_id') is-invalid @enderror" required>
                    ...
                    @foreach($departments as $department)
                      <option value="{{ $department->id }}" 
                              {{ (old('department_id', $videosDepartment->department_id) == $department->id) ? 'selected' : '' }}>
                        {{ $department->name }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  @if($videosDepartment->video)
                    <div class="current-video">
                      <h6><i class="bi bi-video"></i> الفيديو الحالي:</h6>
                      <div class="d-flex align-items-center">
                        <video controls style="max-width: 200px; max-height: 120px;" class="mr-3">
                        ...
                        <div>
                          <a href="{{ route('videos_departments.showVideo', $videosDepartment->id) }}" 
                            ...
                            <i class="bi bi-eye"></i> عرض الفيديو
                          </a>
                        </div>
                      </div>
                      <small class="text-muted mt-2 d-block">
                        لاستبدال الفيديو، اختر ملف جديد أدناه
                      </small>
                    </div>
                  @endif
                  ...
                  <div class="file-input-wrapper">
                    ...
                    <label for="video" class="file-input-label" id="fileLabel">
                      ...
                      <div class="mt-2">
                        <strong>اضغط لرفع فيديو جديد</strong>
      ...
      <div class="card custom-card">
        <div class="card-body">
          ...
          <div class="alert alert-info">
            <h6><i class="bi bi-info-circle"></i> تعليمات التعديل:</h6>
            <ul class="mb-0">
              <li>يمكنك تغيير القسم المحدد</li>
              <li>للاستبدال الفيديو، اختر ملف جديد</li>
              <li>إذا لم تختر ملف جديد، سيتم الاحتفاظ بالفيديو الحالي</li>
    ...
    document.getElementById('video').addEventListener('change', function(e) {
      ...
      if (file) {
        ...
        label.innerHTML = `
          ...
          <div class="mt-2">
            <strong class="text-success">تم اختيار فيديو جديد</strong>
