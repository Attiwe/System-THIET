...
@section('title', 'تعديل التربية العسكرية')
...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> ✏️ تعديل التربية العسكرية </h2>
        <p class="mg-b-0"> تعديل محتوى التربية العسكرية </p>
      </div>
    </div>
...
@section('content')
  <div class="container-fluid">
      ...
      <div class="row align-items-center">
        <div class="col-md-8">
          <div class="d-flex align-items-center">
            ...
            <div>
              <h1 class="mb-2 fw-bold">تعديل التربية العسكرية</h1>
              <p class="mb-0 opacity-75">قم بتعديل محتوى التربية العسكرية</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="d-flex justify-content-end">
            <a href="{{ route('military-education.show', $militaryEducation->id) }}" 
    ...
    <div class="edit-form-container">
      ...
      <form action="{{ route('military-education.update', $militaryEducation->id) }}" method="POST" id="editForm" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
          ...
          <div class="col-12">
            <div class="mb-4">
              ...
              <textarea class="form-control" name="description" required 
                placeholder="اكتب وصف التربية العسكرية هنا..." rows="10">{{ old('description', $militaryEducation->description) }}</textarea>
              <div class="invalid-feedback">يرجى إدخال وصف التربية العسكرية</div>
              <div class="char-counter text-muted" id="charCount">
                {{ strlen(old('description', $militaryEducation->description)) }} / 5000 حرف
              </div>
            </div>
          </div>
        </div>
