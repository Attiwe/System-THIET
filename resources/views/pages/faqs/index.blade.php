        ...
        <tbody>
          @foreach($faqs as $item)
            <tr>
              ...
              <td class="fw-bold text-danger">{{ $item->question }}</td>
              <td class="fw-bold text-indigo-50  ">{{ $item->answer }}</td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                      <form action="{{ route('faqs.destroy', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.faqs._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
