    ...
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-header text-white">
        <h5 class="modal-title fw-bold" id="staticBackdropLabel">
          <i class="bi bi-plus-circle"></i> إضافة رحلة علمية جديدة
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('scientific_trips.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <!-- اسم الرحلة -->
          <div class="mb-3">
            <label for="trip_name" class="form-label fw-bold">
              <i class="bi bi-geo-alt text-info"></i> اسم الرحلة العلمية <span class="text-danger">*</span>
            </label>
            <input type="text" class="form-control form-control-lg" id="trip_name" name="trip_name" 
                   value="{{ old('trip_name') }}" required>
          </div>
          ...
          <!-- صورة الرحلة -->
          <div class="mb-3">
            <label for="trip_image" class="form-label fw-bold">
              <i class="bi bi-image text-primary"></i> صورة الرحلة العلمية <span class="text-danger">*</span>
            </label>
            <input type="file" class="form-control form-control-lg" id="trip_image" name="trip_image" 
