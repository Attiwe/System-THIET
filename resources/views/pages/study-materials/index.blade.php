...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋 المواد الدراسية </h2>
   ...
   <div class="card card-body">
    <div class="table-responsive mt-3">
      <div class="d-flex justify-content-between align-items-center ">
        <h2 class="text-primary mb-3 "> جدول المواد الدراسية </h2>
        <div class="d-flex gap-3">
          <!-- Department Dropdown -->
          <div class="dropdown">
            <button class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="bi bi-building"></i> <span class="ms-2">الأقسام</span>
            </button>
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="{{ route('study_materials.preparatory_engineering') }}">
                  <i class="bi bi-mortarboard text-primary me-2"></i>إعدادي هندسة
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('study_materials.civil_engineering') }}">
                  <i class="bi bi-building text-success me-2"></i>هندسة المدنية
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('study_materials.communications_engineering') }}">
                  <i class="bi bi-wifi text-info me-2"></i>هندسة الاتصالات والحاسبات
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('study_materials.chemical_engineering') }}">
                  <i class="bi bi-flask text-warning me-2"></i>هندسة الكيمياء
                </a>
              </li>
            </ul>
          </div>
          ...
          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            <i class="bi bi-plus-circle"></i> <span class="ms-2">إضافة مادة دراسية</span>
          </button>
        </div>
      </div>
      <!-- Model academic_years -->
      @include('pages.study-materials._create')
      <br>
      <br>
      <table id="example1"
        ...
        <thead class="px-3 py-2  text-white">
          <tr>
            <th scope="col">#</th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-calendar-week"></i> المواد الدراسية </th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-check-circle"></i> القسم</th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-calendar-week"></i> الفرقة الدراسية</th>
