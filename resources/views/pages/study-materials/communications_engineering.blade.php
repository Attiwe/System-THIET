...
@section('title', '   هندسة الاتصالات و الحاسبات المواد الدراسية')
...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋    المواد الدراسية  هندسة الاتصالات و الحاسبات  </h2>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <div class="d-flex justify-content-between align-items-center ">
        <h2 class="text-primary mb-3 ">📋    جدول المواد الدراسية هندسة الاتصالات و الحاسبات</h2>
