...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋 عناصر الجوده </h2>
    ...
    <div class="table-responsive mt-3">
      <div class="d-flex justify-content-between align-items-center ">
        ...
        <div class="d-flex gap-4">
          <a href="{{ route('quality_item.trashed') }}" class="btn btn-outline-danger">
      ...
      @include('pages.qualityItem._create')
      ...
      <table id="example1"
        ...
        <thead class="px-3 py-2  text-white">
          <tr>
            <th scope="col">#</th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-calendar-week"></i> نموذج الجوده </th>
            <th scope="col" class="text-primary" style="font-size: 18px;"><i class="bi bi-calendar-week"></i> اسم العنصر </th>
        ...
        <tbody>
          @foreach($qualityItems as $item)
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                      <form action="{{ route('quality_item.destroy', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.qualityItem._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
    </div>
