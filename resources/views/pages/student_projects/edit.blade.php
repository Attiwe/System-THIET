...
@section('title', 'تعديل مشروع طلابي')
...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> ✏️💡 تعديل مشروع طلابي </h2>
        <p class="mg-b-0"> تعديل بيانات المشروع الطلابي </p>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="d-flex align-items-center">
              ...
              <div>
                <h1 class="mb-2 fw-bold">تعديل مشروع طلابي</h1>
                <p class="mb-0 opacity-75">تعديل بيانات المشروع: {{ $studentProject->project_name }}</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="edit-card">
          ...
          <form action="{{ route('studentProjects.update', $studentProject->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="doctor_name" name="doctor_name" 
                  value="{{ old('doctor_name', $studentProject->doctor_name) }}" placeholder="أدخل اسم الدكتور" required>
              </div>
              ...
              <div class="col-md-6">
                ...
                <select name="department_id" id="department_id" class="form-select" required>
                  <option value="" {{ old('department_id', $studentProject->department_id) == '' ? 'selected' : '' }}>اختر القسم</option>
                  @foreach ($departments as $department)
                    <option value="{{ $department->id }}" {{ old('department_id', $studentProject->department_id) == $department->id ? 'selected' : '' }}>
                      {{ $department->name }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="row g-3">
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="project_name" name="project_name" 
                  value="{{ old('project_name', $studentProject->project_name) }}" placeholder="أدخل اسم المشروع" required>
              </div>
            </div>
            ...
            <div class="row g-3">
              <div class="col-12">
                ...
                <textarea class="form-control" id="description" name="description" rows="6" 
                  placeholder="أدخل وصف مفصل للمشروع" required>{{ old('description', $studentProject->description) }}</textarea>
              </div>
            </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-text">
                  @if($studentProject->image_work)
                    الصورة الحالية: <a href="{{ route('studentProjects.showImage', $studentProject->id) }}" target="_blank" class="text-primary">عرض الصورة</a>
                  @else
              ...
              <div class="col-md-6">
                ...
                <div class="form-text">
                  @if($studentProject->project_pdf)
                    الملف الحالي: <a href="{{ route('studentProjects.showPdf', $studentProject->id) }}" target="_blank" class="text-primary">عرض الملف</a>
                  @else
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
              ...
              <a href="{{ route('studentProjects.index') }}" class="btn btn-outline-secondary btn-lg px-5">
