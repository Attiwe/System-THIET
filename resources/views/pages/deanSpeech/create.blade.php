  ...
  <div class="row">
    <div class="col-xl-12">
      <div class="card shadow-sm">
        <div class="card-body">
          <div class="main-content-label mb-3 font-weight-bold h3">📰 اضافة خبر </div>
          <br>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="title" name="title"
                  value="{{ old('title', ' كلمة العميد') }}" placeholder="أدخل الاسم الوظيفه  ">
              </div>

              <div class="form-group col-md-6">
                <label for="title" class="font-weight-bold lead "> المدير </label>
                <select name="management_id" class="form-control ">
                  <option value="">اختر المدير</option>
                  @foreach($mangment as $manager)
                    <option value="{{ $manager->id }}">{{ $manager->position }}</option>
                  @endforeach
                </select>
              </div>
            </div>
