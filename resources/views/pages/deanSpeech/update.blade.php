              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('management_name') is-invalid @enderror"
                    id="management_name" name="management_name"
                    value="{{ old('management_name', $news->management_name) }}" placeholder="أدخل اسم العميد الكامل"
                    required>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control @error('title') is-invalid @enderror" id="title" name="title" rows="4"
                    placeholder="أدخل كلمة العميد..." required>{{ old('title', $news->title) }}</textarea>
                  @error('title')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  @if($news->resume)
                    <div class="current-image-wrapper mb-3">
                      ...
                      <a href="{{ asset('image/dean-speech/resumes/' . $news->resume) }}" target="_blank"
                ...
                <div class="form-group">
                  ...
                  @if($news->image)
                    <div class="current-image-wrapper mb-3">
                      ...
                      <img src="{{ asset('image/dean-speech/' . $news->image) }}" alt="صورة العميد" class="current-image">
                    </div>
                  @endif
