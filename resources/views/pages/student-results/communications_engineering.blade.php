...
@section('title', 'نتائج الطلاب - هندسة الاتصالات والحاسبات')
...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📊 نتائج الطلاب - هندسة الاتصالات والحاسبات </h2>
        <p class="mg-b-0"> إدارة وتنظيم نتائج الطلاب لهندسة الاتصالات والحاسبات </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <div class="d-flex justify-content-between align-items-center ">
        <h2 class="text-primary mb-3 ">📊 جدول نتائج الطلاب - هندسة الاتصالات والحاسبات</h2>
