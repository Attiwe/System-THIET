...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📊 نتائج الطلاب </h2>
        <p class="mg-b-0"> إدارة وتنظيم نتائج الطلاب للكليات المختلفة </p>
      </div>
    </div>
   ...
   <div class="card card-body">
    <div class="table-responsive mt-3">
      <div class="d-flex justify-content-between align-items-center ">
        <h2 class="text-primary mb-3 "> جدول نتائج الطلاب </h2>
        <div class="d-flex gap-3">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="{{ route('student-results.preparatory_engineering') }}">
                  <i class="bi bi-mortarboard text-primary me-2"></i>إعدادي هندسة
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('student-results.civil_engineering') }}">
                  <i class="bi bi-building text-success me-2"></i>هندسة المدنية
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('student-results.communications_engineering') }}">
                  <i class="bi bi-wifi text-info me-2"></i>هندسة الاتصالات والحاسبات
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('student-results.chemical_engineering') }}">
          ...
          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            <i class="bi bi-plus-circle"></i> <span class="ms-2">إضافة نتيجة طالب</span>
          </button>
        </div>
      </div>
      <!-- Model academic_years -->
      @include('pages.student-results._create')
      <br>
      <br>
      <table id="example1"
