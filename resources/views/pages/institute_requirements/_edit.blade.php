    ...
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-header text-white">
        <h5 class="modal-title fw-bold" id="editModalLabel{{ $requirement->id }}">
          <i class="bi bi-pencil-square"></i> تعديل متطلبات المعهد
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('institute_requirements.update', $requirement->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
