    ...
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-header text-white">
        <h5 class="modal-title fw-bold" id="staticBackdropLabel">
          <i class="bi bi-plus-circle"></i> إضافة متطلبات المعهد
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('institute_requirements.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3">
            <label for="file_path" class="form-label fw-bold">
              <i class="bi bi-file-earmark text-danger"></i> ملف متطلبات المعهد <span class="text-danger">*</span>
            </label>
