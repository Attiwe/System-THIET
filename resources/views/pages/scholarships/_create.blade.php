    ...
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-header text-white">
        <h5 class="modal-title fw-bold" id="staticBackdropLabel">
          <i class="bi bi-calendar-week"></i> إضافة منح دراسية
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('scholarships.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="details" name="details"
          ...
          <div class="mb-3">
            <label for="image_path" class="form-label fw-bold">
              <i class="bi bi-calendar-date text-primary"></i> الصورة
            </label>
            <input type="file" class="form-control form-control-lg" id="image_path" name="image_path"
              required>
          </div>
          <br>
