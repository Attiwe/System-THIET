    ...
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-header text-white">
        <h5 class="modal-title fw-bold" id="staticBackdropLabel">
          <i class="bi bi-plus-circle"></i> إضافة مختبر جديد
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('labs.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <!-- اسم المختبر -->
          <div class="mb-3">
            <label for="lab_name" class="form-label fw-bold">
              <i class="bi bi-flask text-success"></i> اسم الملف <span class="text-danger">*</span>
            </label>
          ...
          <!-- ملف المختبر -->
          <div class="mb-3">
            <label for="lab_pdf" class="form-label fw-bold">
              <i class="bi bi-file-earmark text-danger"></i> ملف   <span class="text-danger">*</span>
            </label>
            <input type="file" class="form-control form-control-lg" id="lab_pdf" name="lab_pdf" 
