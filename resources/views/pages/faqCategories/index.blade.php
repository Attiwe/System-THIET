...
@section('title', 'اقسام الأسئلة الشائعة')
    ...
    <div class="table-responsive mt-3">
      ...
      <div class="d-flex justify-content-center ">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold">  إضافة قسم الأسئلة الشائعة</strong>
        </button>
      </div>

      <!-- Model academic_years -->
      @include('pages.faqCategories._create')
      ...
      <table id="example1"
        ...
        <tbody>
          @foreach($faqCategories as $item)
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                      <form action="{{ route('faqCategories.destroy', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.faqCategories._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
...
@section('js')
    ...
    @include('pages.faqCategories._delete')
@endsection