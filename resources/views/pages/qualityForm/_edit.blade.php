  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-body">
        <form action="{{ route('quality_form.update', $item->id) }}" method="POST">
          @csrf
          @method('PUT')  
          <input type="hidden" name="id" value="{{ $item->id }}">
           ...
           <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control form-control-lg" id="description" name="description" rows="2"
                placeholder=" ادخل الملاحظات ان وجدت ">{{ $item->description ?? old('description') }}</textarea>
            </div>
           </div>
