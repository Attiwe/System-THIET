...
@section('title', 'النماذج المحذوفه')
...
@section('page-header')
  ...
  <div class="card card-body">
    ...
    <div class="d-flex justify-content-between align-items-center">
      <h2 class="text-primary mb-3">📋 النماذج المحذوفه </h2>
      <a href="{{ route('quality_form.index') }}" class="btn btn-outline-primary">
      ...
      <tbody>
        @foreach($qualityForms as $item)
          <tr>
            ...
            <td>
              <!-- restore -->
              <form action="{{ route('quality_form.restore', $item->id) }}" method="POST" class="d-inline">
                @csrf
                @method('HEAD')
              ...
              <!-- delete -->
              <form action="{{ route('quality_form.forceDelete', $item->id) }}" method="POST" class="d-inline">
                @csrf
                @method('delete')
