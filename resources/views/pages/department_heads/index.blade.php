...
@section('page-header')
  ...
  جدول رؤساء الأقسام
        ...
        <p class="mg-b-0"> يعرض جدول رؤساء الأقسام </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <h2 class="text-primary mb-3">  جدول رؤساء الأقسام</h2> <i class="bi bi-people-fill text-primary me-2"></i>

      <!-- إحصائيات العدادات -->
      @if(isset($countersStats) && !empty($countersStats))
      <div class="row mb-4">
        @foreach($countersStats as $deptId => $count)
          @php
      ...
      <div class="d-flex justify-content-center ">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold"> إضافة رئيس قسم</strong>
        </button>
      </div>

      <!-- Model department_heads -->
      @include('pages.department_heads._create')
      ...
      <table id="example1"
        ...
        <tbody>
          @foreach($departmentHeads as $item)
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                      <form action="{{ route('department_heads.destroy', $item['id']) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.department_heads._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
...
@section('js')
    ...
    @include('pages.department_heads._delete')
@endsection
