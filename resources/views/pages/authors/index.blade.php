...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> <i class="bi bi-person-badge"></i> جدول المؤلفين </h2>
        <p class="mg-b-0"> يعرض جدول المؤلفين </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <h2 class="text-primary mb-3"> <i class="bi bi-person-badge"></i> جدول المؤلفين</h2>

      <div class="d-flex justify-content-end ">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createAuthor">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold"> إضافة مؤلف</strong>
        </button>
      </div>
      <br>

      <!-- Model authors -->
      @include('pages.authors._create')
      ...
      <table id="example1"
        ...
        <thead class="px-3 py-2  text-white">
          <tr>
            <th scope="col">#</th>
            <th scope="col" class="h5 text-primary" style="font-size: 18px;"><i class="bi bi-person"></i> اسم المؤلف</th>
        ...
        <tbody>
          @foreach($authors as $item)
            ...
            <!-- model edit -->
            @include('pages.authors._edit', compact('item'))
          @endforeach
        </tbody>
      </table>
