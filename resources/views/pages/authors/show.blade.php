...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> <i class="bi bi-person-badge"></i> تفاصيل المؤلف </h2>
        <p class="mg-b-0"> عرض تفاصيل المؤلف </p>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-header bg-primary text-white">
            <h4 class="card-title mb-0">
              <i class="bi bi-person-badge"></i> تفاصيل المؤلف
            </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="form-label fw-bold">
                    <i class="bi bi-person text-primary"></i> اسم المؤلف:
                  </label>
                  <p class="form-control-plaintext">{{ $author->name }}</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="form-label fw-bold">
                    <i class="bi bi-calendar text-primary"></i> تاريخ الإنشاء:
                  </label>
                  <p class="form-control-plaintext">{{ $author->created_at->format('Y-m-d H:i:s') }}</p>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="border p-3 rounded">
                    {{ $author->description ?? 'لا يوجد وصف' }}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <p class="form-control-plaintext">{{ $author->updated_at->format('Y-m-d H:i:s') }}</p>
                </div>
              </div>
            </div>
          </div>
