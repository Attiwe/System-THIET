      ...
      <div class="card-body bg-white">
        ...
        <form action="{{ route('departments.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="depart_vision" name="depart_vision" rows="3"
                placeholder="أدخل رؤية البرنامج">{{ old('depart_vision') }}</textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="depart_massage" name="depart_massage" rows="3"
                placeholder="أدخل رسالة البرنامج">{{ old('depart_massage') }}</textarea>
            </div>
            <br>
            <div class="row">
              <div class="form-group col-md-6">
          ...
          <div class="d-flex justify-content-center mt-3">
            <button type="submit" class="btn btn-outline-primary font-weight-bold ml-2">✔ إضافة البرنامج</button>
            <button type="reset" class="ml-2 btn btn-outline-danger font-weight-bold">❌ إلغاء</button>
          </div>
        </form>
      </div>
    </div>
