...
@section('title', 'متطلبات البرنامج')
...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋 جدول متطلبات البرنامج </h2>
        <p class="mg-b-0"> يعرض جدول متطلبات البرنامج والملفات المرتبطة بها </p>
      </div>
    </div>
  ...
  <div class="card card-body">
    <div class="table-responsive mt-3">
      <h2 class="text-primary mb-3">📋 جدول متطلبات البرنامج</h2>

      <div class="d-flex justify-content-center">
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          <i class="bi bi-plus-circle"></i> <strong class="h5 font-weight-bold"> إضافة متطلبات البرنامج</strong>
        </button>
      </div>

      <!-- Model program_requirements -->
      @include('pages.program_requirements._create')
      ...
      <table id="example1"
        ...
        <tbody>
          @foreach($programRequirements as $requirement)
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $requirement->id }}">
                    ...
                    <li>
                      <form action="{{ route('program_requirements.destroy', $requirement->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
            ...
            <!-- model edit -->
            @include('pages.program_requirements._edit', compact('requirement'))
          @endforeach
        </tbody>
      </table>
    </div>
...
@section('js')
  ...
  @include('pages.program_requirements._delete')
@endsection
