...
@section('title', 'مديرونائب الوحده  ')
...
@section('page-header')
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1"> 📋 جدول      مديرونائب الوحده       </h2>
        <p class="mg-b-0"> يعرض جدول مديرونائب الوحده   </p>
      </div>
    </div>
...
@section('content')
  <div class="container-fluid py-4">
    <div class="card shadow-sm">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">مديرونائب الوحده  </h5>
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
                ...
                <th class="fw-bold text-primary" style="font-size: 18px;">اسم المدير</th>
                <th class="fw-bold text-primary" style="font-size: 18px;">نائب المدير</th>
            ...
            <tbody>
              @forelse($items as $item)
                <tr>
                  ...
                  <td class="fw-bold">{{ $item->deputy_director }}</td>
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <li>
                          <form action="{{ route('deputy-directors.destroy', $item->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('delete')
                ...
                @include('pages.deputy_directors._edit', ['item' => $item, 'units' => $units])
              @empty
  ...
  @include('pages.deputy_directors._create', ['units' => $units])
@endsection
