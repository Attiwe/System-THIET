  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="left-content">
      <div>
        ...
        <p class="mg-b-0">إنشاء صلاحية فرعية جديدة في النظام</p>
      </div>
    </div>
...
@section('content')
  <div class="card card-body">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="text-primary mb-0">🛡️ إضافة صلاحية جديدة</h2>
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-info text-white">
              <h5 class="mb-0"><i class="bi bi-lightbulb"></i> أمثلة على الصلاحيات</h5>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="text-primary">إدارة المستخدمين:</h6>
                  <ul class="list-unstyled">
                    <li><code>users.create</code> - إنشاء المستخدمين</li>
                    <li><code>users.read</code> - عرض المستخدمين</li>
                    <li><code>users.update</code> - تحديث المستخدمين</li>
                    <li><code>users.delete</code> - حذف المستخدمين</li>
                  </ul>
                </div>
                <div class="col-md-6">
                  <h6 class="text-primary">إدارة الأقسام:</h6>
                  <ul class="list-unstyled">
                    <li><code>departments.create</code> - إنشاء الأقسام</li>
                    <li><code>departments.read</code> - عرض الأقسام</li>
                    <li><code>departments.update</code> - تحديث الأقسام</li>
                    <li><code>departments.delete</code> - حذف الأقسام</li>
                  </ul>
                </div>
              </div>
            </div>
